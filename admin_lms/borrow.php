...
<div class="span3">
            ...
            <div class="control-group"> 
					...
					<div class="controls">
					<input type="text"  class="w8em format-d-m-y highlight-days-67" name="borrow_date_2" id="sd2" maxlength="10" style="border: 3px double #CCCCCC;" value="<?php $date1=date("Y-m-d");
