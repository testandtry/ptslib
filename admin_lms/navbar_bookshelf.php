      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<ul class="nav">
					<li class=""><a href="dashboard.php"><i class="icon-home icon-large"></i>&nbsp;Home</a></li>
                    ...
                    <li class="active"><a href="view_bookshelf.php"><i class="icon-book icon-large"></i>&nbsp;Bookshelf</a></li>
