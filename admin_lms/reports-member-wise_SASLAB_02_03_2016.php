		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Member Wise Report</strong>
                                </div>
						<!--  -->
								    <ul class="nav nav-pills">
										<li><a href="reports.php">All</a></li>
										<li  class="active"><a href="reports-member-wise.php">Member Wise</a></li>
...
<div class="span3">
            ...
            <?php /*?><div class="span3">
				...
				<div class="control-group"> 
                 ...
                 <label class="control-label" for="inputEmail">Due Date To</label>
					<div class="controls">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  if(@$_REQUEST['member_id']!="") {
								  		$q_str .= " and (member.member_id = '".$_REQUEST['member_id']."') ";
								  }
