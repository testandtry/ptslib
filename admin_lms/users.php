			...
			<div class="span10">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  $user_query=mysql_query("select * from ".DB_TABLE_USERS."  ")or die(mysql_error());
								  } else {
									   $user_query=mysql_query("select * from ".DB_TABLE_USERS."  WHERE user_type='".$_SESSION['user_type']."'")or die(mysql_error());
								  }
                                    ...
                                    <td><?php echo $row['user_type']==1?'Super Admin':'Admin'; ?></td> 
                                    <td width="100">
