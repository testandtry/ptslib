	...
	mysql_query("insert into ".DB_TABLE_USERS." (username,password,firstname,lastname,user_type) values('$username','$password','$firstname','$lastname','$user_type')")or die(mysql_error());
	}
	?>